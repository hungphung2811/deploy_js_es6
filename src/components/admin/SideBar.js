    ...
    render() {
        return /*html*/ `
            <aside class="pt-2 bg-gray-100 col-span-2 shadow border-r-2 border-gray-200">
                <div class="mt-3 pl-3">
                    <h2 class="text-green-500 text-xl font-semibold">
                        <a href="/#/admin">Admin Fpolyshop</a>
                    </h2>
                </div>
                <div class="mt-4 font-medium text-sm">
                    <ul>
                        <li class="group">
                            <a class="flex pl-3 py-1.5 items-center text-gray-700 group-hover:bg-gray-500" href="/#/admin">
                        ...
                        <li class="group">
                            <a class="flex pl-3 py-1.5 items-center text-gray-700 group-hover:bg-gray-500" href="/#/admin/order">
                        ...
                        <li class="group">
                            <a class="flex pl-3 py-1.5 items-center text-gray-700 group-hover:bg-gray-500" href="/#/admin/products">
                        ...
                        <li class="group">
                            <a class="flex pl-3 py-1.5 items-center text-gray-700 group-hover:bg-gray-500" href="/#/admin/categories">
                        ...
                        <li class="group">
                            <a class="flex pl-3 py-1.5 items-center text-gray-700 group-hover:bg-gray-500" href="/#/admin/customers">
                        ...
                        <li class="group">
                            <a class="flex pl-3 py-1.5 items-center text-gray-700 group-hover:bg-gray-500" href="/#/admin/blog">
                        ...
                        <li class="group">
                            <a class="flex pl-3 py-1.5 items-center text-gray-700 group-hover:bg-gray-500" href="/#/admin/contact">
