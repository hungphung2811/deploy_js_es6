                            ...
                            <div class="px-4 py-5 bg-white">
                                    <div class="grid grid-cols-6 gap-4">
                                        ...
                                        <div class="col-span-6 sm:col-span-6">
                                            ...
                                            <input value="${category.cateName}" type="text" id="categoryNameId" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500  w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>
                                        ...
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-3">
                                            <img src="${category.image}" id="categoryImagePreviewId" class="w-24 h-auto" alt="">
                                        </div>
                                        ...
                                        <div class="col-span-6 sm:col-span-6">
                                            ...
                                            <div class="mt-1">
                                            <textarea rows="3" id="short_descCategoryId" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="you@example.com">${category.short_desc}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
